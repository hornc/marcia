...
"""
Takes a binary MARC file containing bibliographic records (possibly mixed with holdings records)
and adds a custom / local field 976$a for local barcode importing.
"""
